...
The scripts are self-contained HackBot demo files. They expect Quanser's Python libraries to be available either from a full Quanser checkout or through `QUANSER_PYTHON_PATH`.
...
| `runtime_paths.py` | Adds a local Quanser Python path when available. |
